...
function ensureNavigation() {
  ...
  if (!nav || nav.querySelector('[data-series-planner]')) return;
  const button = document.createElement('button');
  button.textContent = 'Bandplaner';
  button.dataset.seriesPlanner = 'true';
