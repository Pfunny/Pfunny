...
import CoverDesignerPro from './CoverDesignerPro';

let root: Root | null = null;
function ensureNavigation(){
  const nav=document.querySelector('.sidebar nav');
  if(!nav||nav.querySelector('[data-cover-designer-pro]')) return;
  const button=document.createElement('button');
  button.textContent='Cover-Designer Pro';
  button.dataset.coverDesignerPro='true';
